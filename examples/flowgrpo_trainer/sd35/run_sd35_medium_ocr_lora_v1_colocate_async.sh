#!/usr/bin/env bash
# SD3.5-Medium LoRA OCR recipe (V1 trainer: colocate_async mode).
#
# This is the colocate-async counterpart of run_sd35_medium_ocr_lora_v1.sh. It
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    trainer.experiment_name=sd35_medium_ocr_lora_v1_colocate_async \
