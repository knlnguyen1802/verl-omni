#!/usr/bin/env bash
# Qwen-Image DiffusionNFT LoRA RL (V1 trainer: TransferQueue + ReplayBuffer + sync mode).
#
# This is the v1 counterpart of run_qwen_image_ocr_lora.sh. It uses
...
# verl-omni/examples/diffusionnft_trainer/qwen_image/run_qwen_image_ocr_lora.sh
set -x
