...
#
# This is the v1 counterpart of run_minimax_h3_t2va_lora.sh. It uses
...
# verl-omni/examples/diffusionnft_trainer/minimax_h3/run_minimax_h3_t2va_lora.sh
set -x
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    trainer.experiment_name=minimax_h3_t2va_lora_v1 \
