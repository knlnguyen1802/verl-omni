...
#
# This is the v1 counterpart of run_minimax_h3_ref2va_lora.sh. It uses
...
# set on the CLI. GPU layout stays colocated (same as v0).
#
# Reference (legacy v0 script):
# verl-omni/examples/diffusionnft_trainer/minimax_h3/run_minimax_h3_ref2va_lora.sh
set -euo pipefail

export WANDB_MODE=${WANDB_MODE:-online}
export WANDB_RUN_ID=${WANDB_RUN_ID:-minimax_h3_ref2va_lora_v1}
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
  ...
  trainer.experiment_name=minimax_h3_ref2va_lora_v1 \
