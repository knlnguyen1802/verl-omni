...
#   - actor param/optimizer offload stay false: the trainer pool is dedicated
#     (no rollout colocated), so offload only adds PCIe hops per step and opens
#     the CPU-resident window behind the fsdp2 snapshot-aliasing freeze
#     (verl-omni#645).
#
