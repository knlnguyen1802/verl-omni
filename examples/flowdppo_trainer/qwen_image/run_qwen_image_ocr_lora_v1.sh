#!/usr/bin/env bash
# Qwen-Image LoRA RL with Flow-DPPO (V1 trainer: TransferQueue + ReplayBuffer + sync mode).
#
...
# verl-omni/examples/flowdppo_trainer/qwen_image/run_qwen_image_ocr_lora.sh
# Paper: https://arxiv.org/abs/2606.11025
set -x
